...
export function Footer() {
  ...
  return (
    <footer 
        className="section px-3 flex justify-center" 
        aria-labelledby="footer-heading"
    >
    <div
      className='container rounded-t-[20px] sm:p-10 p-5 py-10 sm:py-0 bg-top-center bg-cover'
      style={{ backgroundImage: 'url("./assets/img/saas-3/hero/hero-bg.jpg")' }}
    >
      <h2 id="footer-heading" className="sr-only">
        Footer
      </h2>
      <div className="mx-auto pb-8 pt-16 sm:pt-24 lg:pt-32">
        <div className="md:flex md:flex-row items-start md:gap-8">
          <div className="space-y-8 sm:w-1/3 w-[100%]">
            ...
            <p 
                className='sm:w-[48%] w-[70%] text-lead tracking-[1px] font-exo text-lg font-extralight leading-normal mt-6 mb-10'
            >
              CardSell - Цировые карты с конвертацией в криптовалюту.
            </p>
