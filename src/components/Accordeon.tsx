  ...
  return (
    ...
    >
      {items.map((item, index) => (
        ...
        >
            <div 
                className="accordion-header cursor-pointer flex flex-row justify-between sm:py-6 py-4 sm:px-8 px-5 rounded-[8px] border border-stone-200 shadow-md shadow-stone-200" onClick={() => toggleAccordion(index)}
            >
